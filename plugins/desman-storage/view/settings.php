...
<tr valign="top">
	<td>
		<h3><?php _e( 'S3 Bucket Settings', 'as3cf' ); ?></h3>
...
<tr valign="top">
	<td>
		<h3><?php _e( 'Public (web) access settings', 'as3cf' ); ?></h3>

		<label><?php _e( 'Domain Name', 'as3cf' ); ?></label><br />
		<?php $cfurl = esc_attr( $this->get_setting('cloudfront') ) ?: esc_attr( $this->get_setting('bucket') ) .".". S3_BASE_URL; ?>
		<input type="text" name="cloudfront" value="<?php echo $cfurl; ?>" size="50" />
		<br />
